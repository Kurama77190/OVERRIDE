...
Ok nous allons devoir trouver le mot de passe.
...
```bash
   ...
   0x080484ee <+90>:	movl   $0x804863  9,(%esp)
   ...
   0x0804851f <+139>:	ret 
```
Nous voyons avec gdb un ``cmp`` qui permets d'acceder a ``<system("/bin/sh")>`` affichons avec quoi ``$eax`` est comparer.
...
5276
```
> _INFO_:**5276 est le mot de passe attendu par scanf.**


### ASSEMBLY TO C

Clique [**ICI**](./Ressources/main.c) si tu veux voir le code en **C**
